  ...
  <div class='admin-create-wrapper'>
    <div class='admin-create'>
      ...
      <AccordeonWithSlot title='Basic info'>
        <BaseSelect on-admin :current='basicInfo.host' title='Host' mb='22' @changeValue='changeHost' />
      ...
      <AccordeonWithSlot title='Game info'>
        ...
        <div class='flex-between'>
          <BaseSelect
            ...
            class='mode'
            on-admin
            @changeValue='changeGameMode' />

          <BaseSelect
            title='Map voting system'
            :current='game.mapVotingSystem'
            class='voting'
            on-admin
      ...
      <AccordeonWithSlot title='Registration'>
        ...
        <BaseSelect class='checkinTime' on-admin />
      ...
      <AccordeonWithSlot title='If paid'>
        <InputWithText class='register-cost' v-model='registration.cost' text='Register Cost' />
      </AccordeonWithSlot>
